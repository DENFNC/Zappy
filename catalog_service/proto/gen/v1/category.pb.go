...
const file_category_proto_rawDesc = "" +
	"\n" +
	"\x0ecategory.proto\x12\bcategory\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x10pagination.proto\"f\n" +
	"\x15CreateCategoryRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x129\n" +
	"\tparent_id\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\bparentId\"H\n" +
	...
	"\x0eCreateCategory\x12\x1f.category.CreateCategoryRequest\x1a .category.CreateCategoryResponseB9Z7github.com/DENFNC/Zappy/catalog_service/proto/gen/v1;v1b\x06proto3"
...
var file_category_proto_depIdxs = []int32{
	5, // 0: category.CreateCategoryRequest.parent_id:type_name -> google.protobuf.StringValue
	4, // 1: category.CreateCategoryResponse.category:type_name -> category.Category
	6, // 2: category.ListCategoriesRequest.pagination:type_name -> common.Pagination
	4, // 3: category.ListCategoriesResponse.categories:type_name -> category.Category
	6, // 4: category.ListCategoriesResponse.pagination:type_name -> common.Pagination
