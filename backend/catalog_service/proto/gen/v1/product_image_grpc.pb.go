...
const (
	ProductImageService_UploadFileURL_FullMethodName = "/product_image.ProductImageService/UploadFileURL"
)
...
type ProductImageServiceClient interface {
	UploadFileURL(ctx context.Context, in *UploadURLRequest, opts ...grpc.CallOption) (*UploadURLResponse, error)
}
...
func (c *productImageServiceClient) UploadFileURL(ctx context.Context, in *UploadURLRequest, opts ...grpc.CallOption) (*UploadURLResponse, error) {
...
type ProductImageServiceServer interface {
	UploadFileURL(context.Context, *UploadURLRequest) (*UploadURLResponse, error)
...
func (UnimplementedProductImageServiceServer) UploadFileURL(context.Context, *UploadURLRequest) (*UploadURLResponse, error) {
...
func _ProductImageService_UploadFileURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductImageServiceServer).UploadFileURL(ctx, req.(*UploadURLRequest))
	}
