...
type CreateCategoryResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CategoryId    *v1.ResourceID         `protobuf:"bytes,1,opt,name=category_id,json=categoryId,proto3" json:"category_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateCategoryResponse) GetCategoryId() *v1.ResourceID {
	if x != nil {
		return x.CategoryId
	}
	return nil
...
const file_category_v1_category_proto_rawDesc = "" +
	"\n" +
	"\x1acategory/v1/category.proto\x12\vcategory.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\x1a\x16common/v1/common.proto\"p\n" +
	...
	"\vcategory_id\x18\x01 \x01(\v2\x15.common.v1.ResourceIDR\n" +
	"categoryId\"U\n" +
	...
	"\n" +
	"categories\x18\x01 \x03(\v2\x15.category.v1.CategoryB\t\xfaB\x06\x92\x01\x03\x10\xc8\x01R\n" +
	"categories\x12=\n" +
	"\n" +
	...
	"\n" +
	"updated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2\xba\x03\n" +
	"\x0fCategoryService\x12\x85\x01\n" +
	"\x0eListCategories\x12\".category.v1.ListCategoriesRequest\x1a#.category.v1.ListCategoriesResponse\"*\x82\xd3\xe4\x93\x02$\x12\"/api/v1/catalog_service/categories\x12\x88\x01\n" +
	"\x0eCreateCategory\x12\".category.v1.CreateCategoryRequest\x1a#.category.v1.CreateCategoryResponse\"-\x82\xd3\xe4\x93\x02':\x01*\"\"/api/v1/catalog_service/categories\x12\x93\x01\n" +
	"\x0eDeleteCategory\x12\".category.v1.DeleteCategoryRequest\x1a#.category.v1.DeleteCategoryResponse\"8\x82\xd3\xe4\x93\x022*0/api/v1/catalog_service/categories/{category_id}B9Z7github.com/DENFNC/Zappy/catalog_service/proto/gen/v1;v1b\x06proto3"
...
var file_category_v1_category_proto_goTypes = []any{
	...
	(*ListCategoriesRequest)(nil),  // 2: category.v1.ListCategoriesRequest
	(*ListCategoriesResponse)(nil), // 3: category.v1.ListCategoriesResponse
	(*DeleteCategoryRequest)(nil),  // 4: category.v1.DeleteCategoryRequest
	(*DeleteCategoryResponse)(nil), // 5: category.v1.DeleteCategoryResponse
	(*Category)(nil),               // 6: category.v1.Category
	(*v1.ResourceID)(nil),          // 7: common.v1.ResourceID
...
var file_category_v1_category_proto_depIdxs = []int32{
	7,  // 0: category.v1.CreateCategoryResponse.category_id:type_name -> common.v1.ResourceID
	8,  // 1: category.v1.ListCategoriesRequest.pagination:type_name -> common.v1.PaginationRequest
	6,  // 2: category.v1.ListCategoriesResponse.categories:type_name -> category.v1.Category
	9,  // 3: category.v1.ListCategoriesResponse.pagination:type_name -> common.v1.PaginationResponse
	10, // 4: category.v1.Category.created_at:type_name -> google.protobuf.Timestamp
	10, // 5: category.v1.Category.updated_at:type_name -> google.protobuf.Timestamp
	2,  // 6: category.v1.CategoryService.ListCategories:input_type -> category.v1.ListCategoriesRequest
	0,  // 7: category.v1.CategoryService.CreateCategory:input_type -> category.v1.CreateCategoryRequest
	4,  // 8: category.v1.CategoryService.DeleteCategory:input_type -> category.v1.DeleteCategoryRequest
	3,  // 9: category.v1.CategoryService.ListCategories:output_type -> category.v1.ListCategoriesResponse
	1,  // 10: category.v1.CategoryService.CreateCategory:output_type -> category.v1.CreateCategoryResponse
	5,  // 11: category.v1.CategoryService.DeleteCategory:output_type -> category.v1.DeleteCategoryResponse
