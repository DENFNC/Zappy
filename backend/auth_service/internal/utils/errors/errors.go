...
var (
	...
	ErrUserNotFound       = New("ERR_USER_NOT_FOUND", "user not found", nil)
	ErrInvalidCredentials = New("INVALID_CREDENTIALS", "invalid credentials", nil)
	ErrUserAlreadyExists  = New("USER_ALREADY_EXISTS", "user with this email or username already exists", nil)
