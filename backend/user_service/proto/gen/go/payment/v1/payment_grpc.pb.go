...
const (
	...
	PaymentService_SetDefaultPayment_FullMethodName = "/payment.v1.PaymentService/SetDefaultPayment"
)
...
type PaymentServiceClient interface {
	...
	SetDefaultPayment(ctx context.Context, in *SetDefaultPaymentRequest, opts ...grpc.CallOption) (*SetDefaultPaymentResponse, error)
}
...
func (c *paymentServiceClient) SetDefaultPayment(ctx context.Context, in *SetDefaultPaymentRequest, opts ...grpc.CallOption) (*SetDefaultPaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetDefaultPaymentResponse)
...
type PaymentServiceServer interface {
	...
	SetDefaultPayment(context.Context, *SetDefaultPaymentRequest) (*SetDefaultPaymentResponse, error)
...
func (UnimplementedPaymentServiceServer) SetDefaultPayment(context.Context, *SetDefaultPaymentRequest) (*SetDefaultPaymentResponse, error) {
