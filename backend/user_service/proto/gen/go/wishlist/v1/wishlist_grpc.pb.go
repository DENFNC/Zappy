...
const (
	WishlistItemService_CreateWishlistItem_FullMethodName = "/wishlist.v1.WishlistItemService/CreateWishlistItem"
	WishlistItemService_GetWishlistItem_FullMethodName    = "/wishlist.v1.WishlistItemService/GetWishlistItem"
	WishlistItemService_UpdateWishlistItem_FullMethodName = "/wishlist.v1.WishlistItemService/UpdateWishlistItem"
	WishlistItemService_DeleteWishlistItem_FullMethodName = "/wishlist.v1.WishlistItemService/DeleteWishlistItem"
	WishlistItemService_ListWishlistItems_FullMethodName  = "/wishlist.v1.WishlistItemService/ListWishlistItems"
)
...
type WishlistItemServiceClient interface {
	...
	UpdateWishlistItem(ctx context.Context, in *UpdateWishlistItemRequest, opts ...grpc.CallOption) (*UpdateWishlistItemResponse, error)
...
func (c *wishlistItemServiceClient) CreateWishlistItem(ctx context.Context, in *CreateWishlistItemRequest, opts ...grpc.CallOption) (*CreateWishlistItemResponse, error) {
...
func (c *wishlistItemServiceClient) GetWishlistItem(ctx context.Context, in *GetWishlistItemRequest, opts ...grpc.CallOption) (*GetWishlistItemResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *wishlistItemServiceClient) UpdateWishlistItem(ctx context.Context, in *UpdateWishlistItemRequest, opts ...grpc.CallOption) (*UpdateWishlistItemResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateWishlistItemResponse)
...
func (c *wishlistItemServiceClient) DeleteWishlistItem(ctx context.Context, in *DeleteWishlistItemRequest, opts ...grpc.CallOption) (*DeleteWishlistItemResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type WishlistItemServiceServer interface {
	...
	UpdateWishlistItem(context.Context, *UpdateWishlistItemRequest) (*UpdateWishlistItemResponse, error)
...
func (UnimplementedWishlistItemServiceServer) CreateWishlistItem(context.Context, *CreateWishlistItemRequest) (*CreateWishlistItemResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateWishlistItem not implemented")
}
func (UnimplementedWishlistItemServiceServer) GetWishlistItem(context.Context, *GetWishlistItemRequest) (*GetWishlistItemResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetWishlistItem not implemented")
}
func (UnimplementedWishlistItemServiceServer) UpdateWishlistItem(context.Context, *UpdateWishlistItemRequest) (*UpdateWishlistItemResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateWishlistItem not implemented")
}
func (UnimplementedWishlistItemServiceServer) DeleteWishlistItem(context.Context, *DeleteWishlistItemRequest) (*DeleteWishlistItemResponse, error) {
...
var WishlistItemService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wishlist.v1.WishlistItemService",
